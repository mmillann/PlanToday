...
function Plan() {
  ...
  useEffect(() => {
    const fetchPlanes = async () => {
      try {
        const res = await axios.get("http://52.47.191.228:8080/planes");
  ...
  useEffect(() => {
    const fetchLikedPlanes = async () => {
      try {
        const res = await axios.get(`http://52.47.191.228:8080/likes/${usuarioId}`);
  ...
  const quitarsePlan = (planId) => {
    axios
      .delete(`http://52.47.191.228:8080/participantes/quit/${planId}/${usuarioId}`)
      .then((response) => {
                  ...
                  >
                    ...
                    <Card.Body>
                      <div className="d-flex justify-content-between">
                        ...
                        >
                          <Link to={`http://52.47.191.228:3000/plan/${plan.id}`}>
                            {plan.titulo}
                          </Link>
                        </Card.Title>
