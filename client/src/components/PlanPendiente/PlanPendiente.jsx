...
function PlanPendiente({ idUsuario }) {
    ...
    const obtenerPlanes = async () => {
      try {
        const respuesta = await axios.get(
          `http://localhost:8080/participantes/plan/pendiente/${idUsuario}`
        );
  ...
  return (
    <div className="d-flex justify-content-center mt-5">
      <div className="mt-5 row mx-auto d-flex align-items-center">
        {sinPlanes ? (
