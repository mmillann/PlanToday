...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-05-2023 a las 10:50:05
...
CREATE TABLE `seguimiento` (
  ...
  `id_usuario_seguidor` bigint(20) NOT NULL,
  `id_usuario_seguido` bigint(20) NOT NULL,
...
--
ALTER TABLE `seguimiento`
  ADD CONSTRAINT `seguimiento_ibfk_1` FOREIGN KEY (`id_usuario_seguidor`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `seguimiento_ibfk_2` FOREIGN KEY (`id_usuario_seguido`) REFERENCES `usuarios` (`id`);
